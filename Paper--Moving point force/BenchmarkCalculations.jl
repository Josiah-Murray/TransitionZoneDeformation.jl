...
DataPath = "Paper--Moving point force/Data/Benchmark"
...
DQ_benchmarks = @benchmark CalcDynamicDeformation(xVals_fast, tVals10_fast, parameters, inversionMethod) samples= 10 evals=1 seconds=typemax(Int)
save(DataPath*"/"*graphName*".jld", "Benchmark", DQ_benchmarks)
#GWR_benchmarks = load(DataPath*"/"*graphName*".jld", "Benchmark")
...
GWR_benchmarks = @benchmark CalcDynamicDeformation(xVals_fast, tVals10_fast, parameters, inversionMethod) samples= 10 evals=1 seconds=typemax(Int)
save(DataPath*"/"*graphName*".jld", "Benchmark", GWR_benchmarks)
#GWR_benchmarks = load(DataPath*"/"*graphName*".jld", "Benchmark")
