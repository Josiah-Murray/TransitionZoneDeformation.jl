...
LaplaceDomainFunction = s -> RD.DynamicWithTransitionZones.LaplaceSpaceFunction(xVals, s, xp, v, beamParameters)

#TODO: Invert Laplace transform to get deformation
